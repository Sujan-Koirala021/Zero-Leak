...
import { Shield, Search, FileText, FileCode, AlertTriangle, GitMerge, ShieldAlert } from "lucide-react";
                ...
                {!scanReport ? (
                    <div className="w-full max-w-5xl space-y-8">
                        ...
                        <div className="relative">
                            <Card className="shadow-lg bg-white border-red-200 overflow-hidden">
                                <div className="p-4">
                                    <div className="flex flex-col space-y-4">
                                        <Textarea
                                            placeholder="Enter a public GitHub repository URL to begin your security scan..."
                                            className="min-h-[180px] resize-none border-0 focus:ring-0 text-2xl p-6 bg-transparent"
                                            maxLength={500}
                                        ...
                                        <div className="flex justify-end px-2 pb-2">
                                            <Button
                                                className="bg-red-600 hover:bg-red-700 text-white px-8 py-2 rounded-md font-medium transition-colors"
                                                onClick={() => handleScan(githubUrl)}
                            ...
                            <Card className="p-8 text-center bg-red-50 border-red-200">
                                <div className="space-y-6">
                                    <div className="animate-pulse">
                                        ...
                                        <span className="text-sm font-medium">Note: Please use small repositories to avoid timeouts and processing failures.</span>
                                    </div>
                                    <div>
